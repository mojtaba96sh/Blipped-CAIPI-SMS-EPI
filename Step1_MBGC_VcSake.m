...
disp('Done')
figure();LmyUtility.MY_montage((sos(ifft2c(crop_new(epi_kxkyzc_2shot_lpcCor,[128,128,20,32])))),'displayrange',[0 200]);title('LPC')
figure();LmyUtility.MY_montage((sos(ifft2c(epi_kxkyzc_2shot_sakeCor))),'displayrange',[0 200]);title('VC SAKE')
figure();LmyUtility.MY_montage((abs(ifft2c(crop_new(epi_kxkyzc_2shot_lpcCor(:,:,:,21),[128,128,20])))),'displayrange',[0 20]);title('LPC')
figure();LmyUtility.MY_montage((abs(ifft2c(epi_kxkyzc_2shot_sakeCor(:,:,:,21)))),'displayrange',[0 20]);title('VC SAKE')
figure();LmyUtility.MY_montage((abs(ifft2c(crop_new(epi_kxkyzc_2shot_lpcCor(:,:,:,11),[128,128,20])))),'displayrange',[0 20]);title('LPC')
figure();LmyUtility.MY_montage((abs(ifft2c(epi_kxkyzc_2shot_sakeCor(:,:,:,11)))),'displayrange',[0 20]);title('VC SAKE')
figure();LmyUtility.MY_montage((sos(ifft2c(crop_new(epi_kxkyzc_2shot_lpcCor,[128,128,20,32])))),'displayrange',[0 25]);title('LPC')
figure();LmyUtility.MY_montage((sos(ifft2c(epi_kxkyzc_2shot_sakeCor))),'displayrange',[0 25]);title('VC SAKE')
figure();LmyUtility.MY_montage(db(sos(ifft2c(crop_new(epi_kxkyzc_2shot_lpcCor,[128,128,20,32])))));title('LPC')
