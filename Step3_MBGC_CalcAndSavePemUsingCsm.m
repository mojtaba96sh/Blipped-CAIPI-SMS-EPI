...
CSM_used=crop_new(CSM_xyzc_epi_sakeCor,[128,128,size(CSM_xyzc_epi_sakeCor,3),size(CSM_xyzc_epi_sakeCor,4)]);
...
for iRep=2:nRep
    recon_xyz_pos_RepSum=(recon_xyz_pos_RepSum+recon_xyzr_pos(:,:,:,iRep))/2;
    recon_xyz_neg_RepSum=(recon_xyz_neg_RepSum+recon_xyzr_neg(:,:,:,iRep))/2;
end
