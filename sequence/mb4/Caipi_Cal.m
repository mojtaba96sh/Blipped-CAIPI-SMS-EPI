...
for i=1:Ny % loop over phase encodes
    ...
    elseif i==Ny
        seq.addBlock(gx,adc); % Read the last line of k-space with a single half-blip at the beginning
...
seq.setDefinition('Name', 'C1');
seq.write('C1.seq')       % Write to pulseq file
%seq.install('siemens');
