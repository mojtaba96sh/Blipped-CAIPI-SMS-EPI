...
figure();
subplot(121);imshow(squeeze(I(:,:,1)),[]);
subplot(122);imshow(squeeze(I(:,:,2)),[]);
% subplot(323);imshow(squeeze(I(:,:,3)),[]);
% subplot(324);imshow(squeeze(I(:,:,4)),[]);
% subplot(325);imshow(squeeze(I(:,:,5)),[]);
